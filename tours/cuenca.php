...
<head>
  ...
  <title translate="no">Cuenca  - Tours Ecuador</title>
  <meta name="description" content="Descubre la fascinante historia de las Ruinas de Ingapirca en Ecuador. Sumérgete en la cultura ancestral de los incas y explora sus impresionantes restos arqueológicos. ¡Reserva tu experiencia en Ingapirca y viaja en el tiempo hoy mismo!">
...
<body>
  <div class="principal">
    ...
    <div class="titulo_destino">
      ...
      <h1 class="titulo" translate="no">Cuenca Ingapirca  &nbsp;</h1>
    </div>
    <div class="imagenes-portada">
      <div class="imagenes-portada-primero">
        <a href="../img/cuencaP1.jpeg" data-fancybox="gallery" data-caption="Ruinas de Ingapirca">
          <img src="../img/cuencaP1.jpeg" alt="Ruinas de Ingapirca" class="w3-hover-opacity">
        </a>
      </div>
      <div class="imagenes-portada-segunda">
        <div class="portada-pri">
          <div class="portada-primera1">
            <a href="../img/cuencaP2.jpeg" data-fancybox="gallery" data-caption="Cuenca bus de 2 pisos">
              <img src="../img/cuencaP2.jpeg" alt="Cuenca bus de 2 pisos" class="w3-hover-opacity">
            </a>
          </div>
          <div class="portada-primera1">
            <a href="../img/cuencaP3.jpeg" data-fancybox="gallery" data-caption="Ruinas de Ingapirca">
              <img src="../img/cuencaP3.jpeg" alt="Ruinas de Ingapirca" class="w3-hover-opacity">
            </a>
          </div>
        </div>
        <div class="portada-pri">
          <div class="portada-primera1">
            <a href="../img/cuencaP0.jpeg" data-fancybox="gallery" data-caption="Chordeleg">
              <img src="../img/cuencaP0.jpeg" alt="Chordeleg" class="w3-hover-opacity">
            </a>
          </div>
          <div class="portada-primera1">
            <a href="../img/cuencaP4.jpeg" data-fancybox="gallery" data-caption="Desierto de Palmira">
              <img src="../img/cuencaP4.jpeg" alt="Desierto de Palmira" class="w3-hover-opacity">
            </a>
          </div>
        </div>
      </div>
...
tomar fotos
      ...
      <div class="reservas w3-hide-small">
        ...
        <div class="reservas-primero reservas">
          ...
          <div id="destino">
            <div class="contenido-reserva-p">
              <p>7 <span class="destinos">Destinos</span> &nbsp;</p>
            </div>
            <div class="icono-reserva">
              <i class="fa-solid fa-bus"></i>
            </div>
          ...
          <div class="contacto-reserva" id="reserva">
            <a class="reserva-primero reservarCuencaIngapirca" href="https://api.whatsapp.com/send?phone=593978750531&text=Hola Tours Ecuador 👋%0AEstoy interesado en reservar el tour Cuenca Ingapirca para *ESCRIBIR EL NÚMERO DE PERSONAS* para el *ESCRIBIR LA FECHA DEL VIAJE*%0A%0APor favor si me pueden ayudar con esa reserva. ¡Muchas Gracias!" target="new"> 
          ...
          <div class="contacto-reserva" id="privado">
             <a class="reserva-primero cotizarCuencaIngapirca" href="https://api.whatsapp.com/send?phone=593978750531&text=Hola Tours Ecuador 👋%0A¿Podrían proporcionarme más información sobre los detalles del tour Cuenca Ingapirca, el costo y lo que está incluido?%0A%0AEspero su pronta respuesta. ¡Gracias!" target="new"> 
            <div class="reserva-primero">
              <div class="contenido-reserva-p">
