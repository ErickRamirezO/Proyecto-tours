...
<head>
  ...
  <title translate="no">Quito City Tour - Tours Ecuador</title>
...
<body>
  <div class="principal">
    ...
    <div class="titulo_destino">
      ...
      <h1 class="titulo" translate="no">Quito City Tour &nbsp;</h1>
    </div>
    <div class="imagenes-portada">
      <div class="imagenes-portada-primero">
        <a href="../img/quito-tour-bus-portada.jpg" data-fancybox="gallery" data-caption="Basílica del Voto Nacional">
          <img src="../img/quito-tour-bus-portada.jpg" alt="Basílica del Voto Nacional" class="w3-hover-opacity">
        </a>
      </div>
      <div class="imagenes-portada-segunda">
        <div class="portada-pri">
          <div class="portada-primera1">
            <a href="../img/quito-tour-bus-panecillo.jpg" data-fancybox="gallery" data-caption="Panecillo vista lateral">
              <img src="../img/quito-tour-bus-panecillo.jpg" alt="Panecillo vista lateral" class="w3-hover-opacity">
            </a>
          </div>
          <div class="portada-primera1">
            <a href="../img/quito-tour-bus-panecillo-2.jpg" data-fancybox="gallery" data-caption="Panecillo vista frontal">
              <img src="../img/quito-tour-bus-panecillo-2.jpg" alt="Panecillo vista frontal" class="w3-hover-opacity">
            </a>
          </div>
        </div>
        <div class="portada-pri">
          <div class="portada-primera1">
            <a href="../img/quito-tour-bus-basilica.jpg" data-fancybox="gallery" data-caption="Basílica del Voto Nacional">
              <img src="../img/quito-tour-bus-basilica.jpg" alt="Basílica del Voto Nacional" class="w3-hover-opacity">
            </a>
          </div>
          <div class="portada-primera1">
            <a href="../img/quito-tour-bus-panecillo-3.jpg" data-fancybox="gallery" data-caption="Quito Tour bus">
              <img src="../img/quito-tour-bus-panecillo-3.jpg" alt="Quito Tour bus" class="w3-hover-opacity">
            </a>
          </div>
        </div>
      </div>
        ...
        <div id="myTimeline" class="timeline-red">
            <div data-vtdate="Primera parada">
              ...
              <div class="image-column">
                <img src="../img/quito-tour-bus-naciones-unidas.jpg" alt="Quito Tour Bus en Av. Naciones Unidas" class="cover-image">
              </div>
            ...
            <div data-vtdate="Segunda parada">
              ...
              <div class="image-column">
                <img src="../img/quito-tour-bus-foch.jpg" alt="Plaza Foch" class="cover-image">
              </div>
              <div class="content-column quito_bus_p2">
            ...
            <div data-vtdate="Tercera parada">
              ...
              <div class="image-column">
                <img src="../img/quito-tour-bus-mercado-artesanal.jpg" alt="Mercado artesanal La Mariscal entrada principal" class="cover-image">
              </div>
            ...
            <div data-vtdate="Cuarta parada">
              ...
              <div class="image-column">
                <img src="../img/quito-tour-bus-basilica-v.jpg" alt="Básilica del Voto Nacional" class="cover-image">
              </div>
            ...
            <div data-vtdate="Quinta parada">
              ...
              <div class="image-column">
                <img src="../img/quito-tour-bus-san-francisco.jpg" alt="Iglesia de San Francisco" class="cover-image">
              </div>
            ...
            <div data-vtdate="Sexta parada">
              ...
              <div class="image-column">
                <img src="../img/quito-tour-bus-panecillo-ruta.jpg" alt="Mirador el Panecillo" class="cover-image">
              </div>
      ...
      <div class="reservas w3-hide-small">
        ...
        <div class="reservas-primero">
          ...
          <div class="contacto-reserva" id="reserva">
            <a class="reserva-primero reservarQuitoTourBus" href="https://api.whatsapp.com/send?phone=593978750531&text=Hola Tours Ecuador 👋%0AEstoy interesado en reservar el Quito City Tour para *ESCRIBIR EL NÚMERO DE PERSONAS* para el *ESCRIBIR LA FECHA DEL VIAJE*%0A%0APor favor si me pueden ayudar con esa reserva. ¡Muchas Gracias!" target="new"> 
    ...
    <div class="descripcion w3-row" translate="no">
      ...
      <ul class="indicaciones_quito_tour">  
