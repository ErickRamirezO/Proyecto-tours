...
<head>
  ...
  <title translate="no">Otavalo - Tours Ecuador</title>
  <meta name="description" content="Explora Otavalo en Ecuador, un lugar lleno de cultura indígena y tradiciones ancestrales. Visita el famoso Mercado de Otavalo, con su colorida artesanía y textiles. Conoce la riqueza cultural de esta región.">
...
<body>
  <div class="principal">
    ...
    <div class="titulo_destino">
      ...
      <h1 class="titulo" translate="no">Otavalo &nbsp;</h1>
    </div>
    <div class="imagenes-portada">
      <div class="imagenes-portada-primero">
        <a href="../img/otavaloP2.jpg" data-fancybox="gallery" data-caption="Otavalo_Monumento a los danzantes">
      ...
      <div class="imagenes-portada-segunda">
        <div class="portada-pri">
          <div class="portada-primera1">
            <a href="../img/otavaloP0.jpg" data-fancybox="gallery" data-caption="Cascada de Peguche">
              <img src="../img/otavaloP0.jpg" alt="Cascada de Peguche" class="w3-hover-opacity">
            </a>
          </div>
          <div class="portada-primera1">
            <a href="../img/otavaloP1.jpg" data-fancybox="gallery" data-caption="Mercado Artesanal de Otavalo">
              <img src="../img/otavaloP1.jpg" alt="Mercado Artesanal de Otavalo" class="w3-hover-opacity">
            </a>
          </div>
        </div>
        <div class="portada-pri">
          <div class="portada-primera1">
            <a href="../img/otavaloP3.jpg" data-fancybox="gallery" data-caption="Comerciante en Mercado Artesanal de Otavalo">
              <img src="../img/otavaloP3.jpg" alt="Comerciante en Mercado Artesanal de Otavalo" class="w3-hover-opacity">
            </a>
          </div>
          <div class="portada-primera1">
            <a href="../img/otavaloP4.jpg" data-fancybox="gallery" data-caption="Locales en Mercado Artesanal de Otavalo">
              <img src="../img/otavaloP4.jpg" alt="Locales en Mercado Artesanal de Otavalo" class="w3-hover-opacity">
            </a>
          </div>
        </div>
      </div>
        ...
        <div id="myTimeline">
            <div data-vtdate="Primera parada">
              ...
              <div class="image-column">
                <img src="../img/bizcochos.jpg" alt="Bizcochos de Cayambe" class="cover-image">
              </div>
      ...
      <div class="reservas w3-hide-small">
        ...
        <div class="reservas-primero">
          ...
          <div class="contacto-reserva" id="reserva">
            <a class="reserva-primero reservarOtavalo" href="https://api.whatsapp.com/send?phone=593978750531&text=Hola Tours Ecuador 👋%0AEstoy interesado en reservar el tour Otavalo para *ESCRIBIR EL NÚMERO DE PERSONAS* para el *ESCRIBIR LA FECHA DEL VIAJE*%0A%0APor favor si me pueden ayudar con esa reserva. ¡Muchas Gracias!" target="new"> 
          ...
          <div class="contacto-reserva" id="privado">
             <a class="reserva-primero cotizarOtavalo" href="https://api.whatsapp.com/send?phone=593978750531&text=Hola Tours Ecuador 👋%0A¿Podrían proporcionarme más información sobre los detalles del tour Otavalo, el costo y lo que está incluido?%0A%0AEspero su pronta respuesta. ¡Gracias!" target="new"> 
            <div class="reserva-primero">
              <div class="contenido-reserva-p">
